...
####+END:
        ...
        cmndName = "dispositionToImpressiveInfoStdout" ; comment="""# Args specify purpose"""
...
####+END:
        ...
        opOutcome = latexInputFilesList().cmnd(
            interactive=False,
...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "dispositionToImpressiveInfoStdout" :comment "args are purposes (voiceOver, etc)" :parsMand "" :parsOpt "dispositionBase" :argsMin "1" :argsMax "1000" :asFunc "" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || ICM-Cmnd       :: /dispositionToImpressiveInfoStdout/ =args are purposes (voiceOver, etc)= parsMand= parsOpt=dispositionBase argsMin=1 argsMax=1000 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "dispositionToPresenterStdout" :comment "No longer used" :parsMand "" :parsOpt "" :argsMin "1" :argsMax "1" :asFunc "" :interactiveP ""
"""
...
####+END:
        ...
        dispositionToImpressiveInfoStdout().cmnd(
            interactive=False,
            dispositionBase=dispositionBase,
            argsList=effectiveArgsList,
        )
